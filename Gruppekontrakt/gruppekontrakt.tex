...
\begin{document}
	...
	\begin{itemize}
		...
		\item Jakob, Jacob, Leo, Mathias and Henrik have each given a sum of money towards the deposit for the keys to our grouproom door. Everyone has one key except Henrik, who has two.
	\end{itemize}
