...
Firstly wanted to use an adjacency list and for each vertex, keep a list of its neighbours. 
...
In our case an edge means that there are a switch that would make both vertices contain the given message if the modulo operation is applied with the correct $m$-value. 
...
Another way of representing of a graph, is simply a list of vertices and a list of edges. 
