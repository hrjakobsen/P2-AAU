...
\aautitlepage{%
  ...
  It'll also give some insight in something more contextual, such as if it can be used in Social Media by rebels who lives under a tyrannical regime and whom wishes to communicate with one another, without being detected and risk being executed.
   During the report, some steganographic experiments has been conducted, and the image format known as JPEG, which is by far, the most used format when it comes to sharing images on the internet, has been thoroughly analysed, and the product which has been developed during the writing of this report, has been designed to work on that very format. 
   The product is able to embed a message secretly within the image to make it as difficult to detect by the human eye as possible, using Graph Theory from the branch of Mathematics known as Discrete Mathematics. 
}
