...
\begin{table}[]
	...
	\begin{tabular}{@{}lllllll@{}}
		\toprule
																& \multicolumn{2}{l}{Before compression}                                                                            & \multicolumn{2}{l}{After compression}                                                                             &                                                              &                                                            \\ \midrule
		\begin{tabular}[c]{@{}l@{}}Social\\ medium\end{tabular} & \begin{tabular}[c]{@{}l@{}}Image\\ resolution\end{tabular} & \begin{tabular}[c]{@{}l@{}}Image\\ size\end{tabular} & \begin{tabular}[c]{@{}l@{}}Image\\ resolution\end{tabular} & \begin{tabular}[c]{@{}l@{}}Image\\ size\end{tabular} & \begin{tabular}[c]{@{}l@{}}Euclidean\\ distance\end{tabular} & \begin{tabular}[c]{@{}l@{}}Image\\ extracted?\end{tabular} \\ \midrule
		\multirow{3}{*}{Facebook}                               & 3648x2432                                                  & 18.1MB                                               & 2048x1365                                                  & 152KB                                                & 5936\textsuperscript{\textdagger}                		       & No                                                         \\
																& 1824x1216                                                  & 5.08MB                                               & 1824x1216                                                  & 142KB                                                & 2774                                                         & No                                                         \\
