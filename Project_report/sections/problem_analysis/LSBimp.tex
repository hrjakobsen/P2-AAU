...
By storing the information we want concealed in the two least significant bits, we can keep all of the original information, and changing each pixel of the vessel image, by a maximum value of 3 or $00000011_2$, the concealed image will almost be invisible to the naked eye.
...
\begin{figure}[]
	...
	\begin{subfigure}[b]{.3\linewidth}
		\includegraphics[width=\linewidth]{vessel.jpg}
		\captionof{figure}{Vessel image}
		\label{img1}
	\end{subfigure}
	\hspace{.02\linewidth}
	\begin{subfigure}[b]{.3\linewidth}
		\includegraphics[width=\linewidth]{concealed.jpg}
	...
	\begin{subfigure}[b]{.4\linewidth}
		\includegraphics[width=.97\textwidth]{encrypted.jpg}
