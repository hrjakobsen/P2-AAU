...
\begin{threeparttable}[]
    ...
    \begin{tabular}{|p{3cm}|p{3.2cm}|p{3.2cm}|p{3.2cm}|}
        ...
        Image padding   & 7099 ms               & 39654 ms              & 0000 ms           \\ \hline
        Channel split   & 3265 ms               & 20355 ms              & 0000 ms           \\ \hline
        Encoding        & 4297 ms               & 28045 ms              & 0000 ms           \\ \hline
        Adding edges    & 124 ms                & 1020 ms                & 0000 ms           \\ \hline
        Get switches    & 364 ms                & 2720 ms               & 0000 ms           \\ \hline
        Huffman         & 668 ms                & 3568 ms               & 0000 ms           \\ \hline
        Total run time  & \textbf{16031 ms}     & \textbf{96385 ms}     & \textbf{0000 ms}  \\ \hline
...
\begin{threeparttable}[]
    ...
    \begin{tabular}{|p{2.8cm}|p{1.8cm}|p{1.5cm}|p{1.8cm}|p{1.5cm}|p{1.8cm}|p{1.5cm}|}
        ...
        Image padding   & 87 ms     & 8079 \%   & 526 ms     & 7433 \%    & 7099 ms   & 10 \%      \\ \hline
        Channel split   & 3089 ms   & 6 \%      & 20074 ms   & 1 \%       & 7099 ms   & 10 \%      \\ \hline
        Encoding        & 4297 ms   & 0 \%      & 28921 ms   & -3 \%      & 7099 ms   & 10 \%      \\ \hline
        Adding edges    & 125 ms    & -1 \%     & 995 ms     & 3 \%      & 7099 ms   & 10 \%      \\ \hline
        Get switches    & 365 ms    & 0 \%      & 2797 ms    & 3 \%     & 7099 ms   & 10 \%      \\ \hline
        Huffman         & 650 ms    & 3 \%      & 3604 ms    & -1 \%     & 7099 ms   & 10 \%      \\ \hline
        Total run time  & \textbf{8828 ms} & \textbf{82 \%} & \textbf{57973 ms}& \textbf{66 \%}  & \textbf{0000 ms} & \textbf{10 \%}  \\ \hline
...
\begin{threeparttable}[]
    ...
    \begin{tabular}{|p{2.8cm}|p{1.8cm}|p{1.5cm}|p{1.8cm}|p{1.5cm}|p{1.8cm}|p{1.5cm}|}
        ...
        Code segment    & \multicolumn{6}{c|}{Processor and performance increase} \\ \hline
                        & Intel\textsuperscript{\textregistered} \newline i5-4670K & Increase\tnote{\textdagger} & AMD\textsuperscript{\textregistered} \newline A6-3420M & Increase\tnote{\textdagger} & None & Increase\tnote{\textdagger} \\ \hline
        Image padding   & 86        & 8126 \%    & 503       & 7780 \%    & 7099      & 10 \%     \\ \hline
        Channel split   & 318       & 926 \%     & 5009      & 306 \%     & 7099      & 10 \%     \\ \hline
        Encoding        & 4279      & 0 \%       & 28539     & -2 \%       & 7099      & 10 \%     \\ \hline
        Adding edges    & 100       & 23 \%      & 628       & 63 \%      & 7099      & 10 \%     \\ \hline
        Get switches    & 349       & 4 \%       & 2719      & 0 \%     & 7099      & 10 \%     \\ \hline
        Huffman         & 642       & 4 \%       & 3712      & -4 \%     & 7099      & 10 \%     \\ \hline
        Total run time  & \textbf{5987} & \textbf{168 \%} & \textbf{42208} & \textbf{128 \%} & \textbf{0000} & \textbf{10 \%} \\ \hline
...
\begin{threeparttable}[]
    ...
    \begin{tabular}{|p{2.8cm}|p{1.8cm}|p{1.5cm}|p{1.8cm}|p{1.5cm}|p{1.8cm}|p{1.5cm}|}
        ...
        Code segment    & \multicolumn{6}{c|}{Processor and performance increase} \\ \hline
                        & Intel\textsuperscript{\textregistered} \newline i5-4670K & Increase\tnote{\textdagger} & AMD\textsuperscript{\textregistered} \newline A6-3420M & Increase\tnote{\textdagger} & None & Increase\tnote{\textdagger} \\ \hline
        Image padding   & 88        & 7995 \%    & 521       & 7513 \%    & 7099      & 10 \%     \\ \hline
        Channel split   & 109       & 2884 \%    & 769       & 2546 \%    & 7099      & 10 \%     \\ \hline
        Encoding        & 1782      & 141 \%     & 6977      & 302 \%     & 7099      & 10 \%     \\ \hline
        Adding edges    & 50        & 148 \%     & 190       & 438 \%     & 7099      & 10 \%     \\ \hline
        Get switches    & 324       & 12 \%      & 2295      & 19 \%       & 7099      & 10 \%     \\ \hline
        Huffman         & 651       & 3 \%       & 3914      & -9 \%     & 7099      & 10 \%     \\ \hline
        Total run time  & \textbf{3214} & \textbf{399 \%} & \textbf{15801} & \textbf{510 \%} & \textbf{0000} & \textbf{10 \%} \\ \hline
