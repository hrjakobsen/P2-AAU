...
\lstinputlisting[firstline=169, firstnumber=169, lastline=186, label={code:decodeMessage}, caption={Decodes the message encoded into the JPEG image using the Graph-Theoretic Approach \textbf{File: }JPEGDecoder.cs}]{../Programmer/Stegosaurus/Stegosaurus/JPEG/JPEGDecoder.cs}
