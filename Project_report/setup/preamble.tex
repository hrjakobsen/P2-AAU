...
\lstset{language=[Sharp]C,
	captionpos=b,
	commentstyle=\color{greencomments},
	morekeywords={partial, var, value, get, set, Color, Bitmap, BitList, BitArray, HuffmanElement, HuffmanTable, QuantizationTable, Graph, Vertex, Edge, StreamReader, BinaryReader, List, IntPtr, Graphics, JPEGImage, System, Drawing, Collections, PrivateObject, PrivateType, GraphEncoder },
	keywordstyle=\color{bluekeywords},
	stringstyle=\color{redstrings},
