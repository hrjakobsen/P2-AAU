...
\lstset{language=[Sharp]C,
	captionpos=b,
	commentstyle=\color{greencomments},
	morekeywords={partial, var, value, get, set, Color, Bitmap, Pixel, BitList, BitArray, HuffmanElement, HuffmanTable, QuantizationTable, Graph, Vertex, Edge, StreamReader, BinaryReader, List},
	keywordstyle=\color{bluekeywords},
	stringstyle=\color{redstrings},
