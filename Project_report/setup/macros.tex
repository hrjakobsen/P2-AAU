...
\newcommand{\aautitlepage}[3]{%
  {
    ...
    \iflanguage{danish}{%
      ...
      \clearpage
      \vspace*{\fill}\noindent{\footnotesize\emph{The contents of this report are freely available, but publication (with reference) may only be pursued in agreement with the authors.}}
    }
    \clearpage
  }
}
