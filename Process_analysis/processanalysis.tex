...
\begin{titlepage}
    \centering
    {\scshape\LARGE Process Analysis \par}
    \vspace{1cm}
    {\Large DAT2-A423\\  
...
We believe that this cluster group work would have worked a lot better if we had had someone to take control of communication between the groups and make sure that we had all understood what was meant. 
